...
This `main` branch provides the `Freeze-Thaw PFN surrogate (FT-PFN)` surrogate model from the paper above as a drop-in surrogate for multi-fidelity Bayesian Optimization loops.
