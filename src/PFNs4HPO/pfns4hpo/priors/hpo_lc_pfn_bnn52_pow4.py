...
class DatasetPrior:
    ...
    def new_dataset(self):
        ...
        param_importance = np.random.dirichlet([0.3]*(self.num_inputs-1) + [0.1]) # relative parameter importance
        lscale = np.exp(np.random.normal(0, 1)) # length scale ~ complexity of the landscape
